...
'''
pathlib.Path(r'D:\Sekai_two\memory-9\SekaiForm\src\main\java\com\sekai\sekai_form\tool\TranslateTool.java').write_text(tool, 'utf-8')
print('Created TranslateTool')

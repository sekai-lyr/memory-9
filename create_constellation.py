...
# ConstellationTool - simplified but functional version
tool = r'''package com.sekai.sekai_form.tool;
...
'''
pathlib.Path(r'D:\Sekai_two\memory-9\SekaiForm\src\main\java\com\sekai\sekai_form\tool\ConstellationTool.java').write_text(tool, 'utf-8')
print('Created ConstellationTool')
